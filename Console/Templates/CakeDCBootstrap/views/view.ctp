...
<?php
	echo "\t\t<li><?php echo \$this->Html->link(__('Edit {$singularHumanName}'), array('action' => 'edit', {$idKeyPK})); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Delete {$singularHumanName}'), array('action' => 'delete', {$idKeyPK})); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('List {$pluralHumanName}'), array('action' => 'index'{$additionalParams})); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('New {$singularHumanName}'), array('action' => 'add'{$additionalParams})); ?> </li>\n";
